...
public class CustomerController extends BaseController {
	...
	public Object customerList(
		...
		return BizConnecter.getBizData("805055",
	...
	@ResponseBody
	public Object customerPage(
			@RequestParam Map<String, String> allRequestParams) {
		allRequestParams.put("kind", EUserKind.F1.getCode());
		return BizConnecter.getBizData("805054",
				JsonUtils.mapToJson(allRequestParams), Object.class);
	}
	...
	@ResponseBody
	public Object companyEdit(@RequestBody Map map) {
		// map.put("updater", this.getSessionUser().getUserName());
		return BizConnecter.getBizData("805200", JsonUtils.mapToJson(map),
				Object.class);
	}
	...
	@ResponseBody
	public Object customerBranchPage(
			@RequestParam Map<String, String> allRequestParams) {
		// allRequestParams.put("kind", EUserKind.F1.getCode());
		return BizConnecter.getBizData("805077",
				JsonUtils.mapToJson(allRequestParams), Object.class);
	}
