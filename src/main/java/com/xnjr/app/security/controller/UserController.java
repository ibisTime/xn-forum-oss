...
public class UserController extends BaseController {
	...
	// // 校验用户名密码
	// XN805043Res res = userAO.login((String)map.get("loginName"),
	// (String)map.get("loginPwd"));
	// // 创建session
	// sessionProvider
	// .setUserDetail(new SessionUser(res.getUserId(),
	...
	public Map addUser(
		...
		userAO.allotRole((String) user.get("userId"), roleId, this
	...
	public Object queryUnderUserList() {
		return userAO.queryUserList(null, EUserKind.XiaJia.getCode(), null,
				this.getSessionUser().getUserId(), null, null, null, null,
				null, null, null);
	}
	...
	@ResponseBody
	public Object findPwd(@RequestParam(value = "loginName") String loginName,
			@RequestParam(value = "smsCaptcha") String smsCaptcha,
	...
	@ResponseBody
	public Object findPwdSMS(@RequestParam(value = "loginName") String loginName) {
	...
	public Object levelPage(@RequestParam Map<String, String> allRequestParams) {
		return BizConnecter.getBizData("805113",
	...
	public Object levelList(@RequestParam Map<String, String> allRequestParams) {
		return BizConnecter.getBizData("805114",
				JsonUtils.mapToJson(allRequestParams), Object.class);
	}
}
